...
def main() -> int:
    ...
    checks = [
        ...
        {
            "name": "date_time_grounded_answer",
            "expected": str(datetime.now().date()),
            "prompt": "whats the current date and time",
            "forbidden": ["tool", "running", "schema"],
        },
        {
            "name": "calculator_grounded_answer",
            "expected": "4",
            "prompt": "calculate 2 + 2",
            "forbidden": ["tool", "running", "schema"],
        },
        {
            "name": "weather_grounded_answer",
            "expected": "Delhi",
        ...
        {
            "name": "web_search_extension_grounded_answer",
        ...
        {
            "name": "document_extract_extension_grounded_answer",
        ...
        {
            "name": "hash_tool_grounded_answer",
            "expected": "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad",
            "prompt": "hash abc with sha256",
            "forbidden": ["tool", "running", "schema"],
        },
        {
            "name": "text_stats_grounded_answer",
            "expected": "2",
