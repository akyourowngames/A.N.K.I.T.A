...
import { resolvePath, assertReadable, readTextFile, writeTextFile, restoreTrailing } from "./_shared.mjs";
import { diffText, renderDiff, stats, touchedRange } from "./_diff.mjs";
