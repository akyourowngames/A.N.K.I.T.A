...
import { killTree } from '../tools/run-command.mjs';
import * as kill from '../tools/kill-process.mjs';
import { processIdentity } from '../tools/_process.mjs';
...
test('job tree cleanup survives the group leader exiting with inherited pipes', { timeout: 20000 }, async t => {
  ...
  const tracker = await import('../tools/_job-tree.mjs').catch(() => null);
