...
import { parseDdgHtml, parseGnewsXml, searchDdg, searchRun } from '../tools/web-search.mjs';
import { extractReadable, fetchRun } from '../tools/web-fetch.mjs';
import { run as scrapeLow } from '../tools/scrape-low.mjs';
import { run as scrapeMid } from '../tools/scrape-mid.mjs';
import { run as scrapeHigh } from '../tools/scrape-high.mjs';
