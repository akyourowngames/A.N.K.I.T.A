...
_FILE_TOOLS = {"list_files", "read_file", "read_file_lines", "read_rich_file", "write_file", "edit_file",
               ...
               "copy_path", "make_dir", "file_info", "apply_patch", "write_content", "open_path",
               "launch_app", "resolve_local_target", "file_sync", "pc_search", "trash_path", "disk_analysis",
               "diff_files", "bulk_op",
...
_WEB_TOOLS = {"search_web", "search_news", "search_and_fetch", "fetch_page_content",
              "search_price", "write_content", "write_code_artifact", "download_file", "launch_app", "open_path", "resolve_local_target",
              "deep_research",
...
_SYSTEM_TOOLS = {"system_control", "launch_app", "open_path", "terminate_app", "desktop_interact",
                 ...
                 "translate_command",
                 "kill_process_tree", "port_scan", "env_op", "resolve_local_target"} | _MEMORY_TOOLS
...
_CODE_TOOLS = {"run_command", "apply_patch", "execute_shell", "check_syntax",
               ...
               "launch_app", "resolve_local_target", "search_text", "list_files", "make_dir", "copy_path",
               "rename_path", "delete_path", "move_path", "file_info",
               "search_web", "fetch_page_content", "git_op", "write_code_artifact",
...
_TERMINAL_TOOLS = {"execute_shell", "list_files", "read_file", "run_command", "git_op",
                   "process_op", "fast_file_search", "resolve_local_target",
...
# TaskAgent — Smart to-do management
_TASK_TOOLS = {"task_op", "search_web"} | _MEMORY_TOOLS
...
# ImageAgent — AI image generation via NVIDIA image API
...
CodeWriterAgent = SpecialistAgent("CodeWriterAgent", _CODE_WRITER_TOOLS, _CODE_WRITER_SYSTEM_PROMPT)
